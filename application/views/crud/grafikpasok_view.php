...
foreach ($dataPemasokanChart as $k => $v) {
 ...
 //var_dump ($arrPasok);die();
  ...
  //print_r(json_encode($arrPasok, JSON_NUMERIC_CHECK));die();
  //print_r($dataPemasokanChart);die();
?>
        ...
        <div class="container-fluid">
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h5 class="m-0 font-weight-bold text-dark">Grafik Pemasokan</h6>
      ...
      window.onload = function () {
        ...
        var chart = new CanvasJS.Chart("chartContainer", {
          ...
          data: [{
            ...
            dataPoints: 
              <?php echo json_encode($arrPasok, JSON_NUMERIC_CHECK); ?>
